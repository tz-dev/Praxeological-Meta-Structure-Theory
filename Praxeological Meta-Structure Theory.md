...
Below, we map each PA dimension directly onto combinations of the meta-axioms (Δ–Ψ).
This mapping demonstrates that the PA model is not an interpretive construct but a **systematic projection** of the deep grammar of praxis.
