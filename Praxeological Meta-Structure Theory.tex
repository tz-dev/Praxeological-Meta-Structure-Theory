...
% Operator commands (optional but handy)
\newcommand{\OpD}{\Delta}
\newcommand{\OpI}{\nabla}
\newcommand{\OpF}{\square}
\newcommand{\OpN}{\Lambda}
\newcommand{\OpA}{A}
\newcommand{\OpO}{\Omega}
\newcommand{\OpT}{\Theta}
\newcommand{\OpR}{\Phi}
\newcommand{\OpX}{X}      % Χ simplified
\newcommand{\OpS}{\Sigma}
\newcommand{\OpB}{\Psi}

% Derived axes shortcuts (optional)
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/figure_01.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/figure_02.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/figure_03.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/figure_05.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/figure_04.png}
